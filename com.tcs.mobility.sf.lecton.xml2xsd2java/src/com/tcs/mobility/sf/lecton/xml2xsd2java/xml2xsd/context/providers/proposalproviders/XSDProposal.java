...
public class XSDProposal implements IContentProposal {
	...
	private Map<String, XSDInfo> getFilledXsdMap() {
		if(this.xsdMap == null){
			...
			xsdMap.put("hexBinary", new XSDInfo("hexBinary - byte[]","Arbitrary hex-encoded binary data. Example, “0FB7” is a hex encoding for 16-bit int 4023 (binary 111110110111)"));
			
			xsdMap.put("anyURI", new XSDInfo("anyURI - String","A Uniform Resource Identifier Reference (URI). Can be absolute or relative, and may have an optional fragment identifier"));
			...
			xsdMap.put("decimal", new XSDInfo("decimal - BigDecimal","Arbitrary precision decimal numbers. Sign omitted, “+” is assumed. Leading and trailing zeroes are optional. If the fractional part is zero, the period and following zero(es) can be omitted."));
			xsdMap.put("double", new XSDInfo("double","Double-precision 64-bit floating point type - legal literals {0, -0, INF, -INF and NaN} Example, -1E4, 12.78e-2, 12 and INF"));
			xsdMap.put("float", new XSDInfo("float","32-bit floating point type - legal literals {0, -0, INF, -INF and NaN} Example, -1E4, 1267.43233E12, 12.78e-2, 12 and INF"));
			xsdMap.put("int", new XSDInfo("int","2147483647 to -2147483648. Sign omitted, “+” is assumed. Example: -1, 0, 126789675, +100000"));
			xsdMap.put("long", new XSDInfo("long","9223372036854775807 to - 9223372036854775808. Sign omitted, “+” assumed. Example: -1, 0, 12678967543233, +100000"));
			xsdMap.put("negativeInteger", new XSDInfo("negativeInteger - BigInteger","Infinite set {...,-2,-1}. Example: -1, -12678967543233, -100000"));
			xsdMap.put("nonNegativeInteger", new XSDInfo("nonNegativeInteger - BigInteger","Infinite set {0, 1, 2,...}. Sign omitted, “+” assumed. Example: 1, 0, 12678967543233, +100000"));
			xsdMap.put("nonPositiveInteger", new XSDInfo("nonPositiveInteger - BigInteger","Infinite set {...,-2,-1,0}. Example: -1, 0, -126733, -100000"));
			xsdMap.put("positiveInteger", new XSDInfo("positiveInteger - BigInteger","Infinite set {1, 2,...}. Optional “+” sign,. Example: 1, 12678967543233, +100000"));
			...
			xsdMap.put("date", new XSDInfo("date - XMLGregorianCalendar","Calendar date.Format CCYY-MM-DD. Example, May the 31st, 1999 is: 1999-05-31."));
			xsdMap.put("dateTime", new XSDInfo("dateTime - XMLGregorianCalendar","Specific instant of time. ISO 8601 extended format CCYY-MM-DDThh:mm:ss. Example, to indicate 1:20 pm on May the 31st, 1999 for Eastern Standard Time which is 5 hours behind Coordinated Universal Time (UTC): 1999-05-31T13:20:00-05:00"));
			xsdMap.put("duration", new XSDInfo("duration - Duration","A duration of time. ISO 8601 extended format PnYn MnDTnH nMn S. Example, to indicate duration of 1 year, 2 months, 3 days, 10 hours, and 30 minutes: P1Y2M3DT10H30M. One could also indicate a duration of minus 120 days as: -P120D"));
			...
			xsdMap.put("gYearMonth", new XSDInfo("gYearMonth - XMLGregorianCalendar","Specific gregorian month and year. Example, May 1999, write: 1999-05"));
			xsdMap.put("time", new XSDInfo("time - XMLGregorianCalendar","An instant of time that recurs every day. Example, 1:20 pm for Eastern Standard Time which is 5 hours behind Coordinated Universal Time (UTC), write: 13:20:00- 05:00"));
